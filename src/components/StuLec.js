...
const StuLec = ({courses,handleDash}) => {
                                        ...
                                        <div className="col-md-4 mt-5">
                                            <div className="card">
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <button className='btn btn-success mt-2 cart' onClick={handleDash(1)}><Link to={'/'+course.name} id='lecture'> View Lectures</Link></button>
                                                    {/* <h3>{course.name}</h3> */}
